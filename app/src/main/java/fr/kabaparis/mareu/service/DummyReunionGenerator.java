...
public abstract class DummyReunionGenerator {
    ...
    public static List<Reunion> DUMMY_REUNIONS = Arrays.asList(
            ...
            new Reunion(4, "Réunion D", 1649065625000L, "Kaba",
            ...
            new Reunion(6, "Réunion F", 1648865625000L, "Office",
                    "denise@lamzone.com, alex@lamzone.com, jordan@lamzone.com", R.color.purple_500),
            new Reunion(7, "Réunion G", 1649565625000L, "Security",
                    "marc@lamzone.com, michael@lamzone.com", R.color.teal_200),
            new Reunion(8, "Réunion H", 1647665625000L, "Furniture",
